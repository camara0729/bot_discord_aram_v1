...
class AdminCog(commands.Cog):
    ...
    # COMANDO REMOVIDO: adicionar_pdl - substituído por /ajustar_stats
...
class ResetStatsConfirmView(discord.ui.View):
    ...
    @app_commands.command(name="ajustar_stats", description="[ADMIN] Ajusta qualquer estatística de um jogador de forma unificada.")
    @app_commands.describe(
